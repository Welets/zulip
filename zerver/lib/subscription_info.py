...
def get_web_public_subs(
    ...
    for stream in streams:
        ...
        sub = SubscriptionStreamDict(
            ...
            can_create_topics_group=can_create_topics_group,
...
def build_stream_dict_for_never_sub(
    ...
    can_create_topics_group_value = get_group_setting_value_for_register_api(
        raw_stream_dict["can_create_topics_group_id"], anonymous_group_membership
    )
    ...
    return NeverSubscribedStreamDict(
        ...
        can_create_topics_group=can_create_topics_group_value,
